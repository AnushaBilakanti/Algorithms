...
<li>
Maximum value contiguous subsequence: Given a sequence of n real numbers, a 1 , a 2 , ..., a n ,
give an algorithm for finding a contiguous subsequence for which the value of the sum of the
elements is maximized.
</li>
<li>
2. Car Assembly (see Figure 15.1 in CLRS): A factory has two assembly lines, each with n stations.
...
<li>
10. Two-Person Traversal of a Sequence of Cities: You are given an ordered sequence of n
